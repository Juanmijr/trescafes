    ...
    <body>
        ...
        <div class="row">
            <section class="col-sm-8 text-justify text-secondary pt-5">
                <h1 class="text-title">ASÍ EMPEZÓ</h1><br>
                <p>
            ...
            <aside class="col-sm-4 pt-5">
                <img class="imgRedes" src="img/415.png" alt="imagen del Logo">
            </aside>
        </div>
        <div class="row">
            <aside class="col-sm-4 pt-5">
                <img class="img-fluid" src="img/quienesSomos.png" alt="imagen de cafeteria">
            </aside>
            <section class="col-sm-8 text-justify text-secondary pt-5">
                <h1 class="text-title">NUESTROS VALORES</h1><br>
                <p>
                ...
                <h1 class="text-title">NUESTRA FILOSOFÍA</h1><br>
                <p>
