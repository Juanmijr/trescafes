<html lang="es">
    <head>
        ...
        <title>Calidad | Tres Cafés</title>
    </head>
    <body>
        <?php
            ...
            <main class="row mt-5">
                ...
                <article class=" col-md-9">
                    ...
                    <div  class="pt-4 pb-5 text-justify text-secondary">
                        ...
                        <p>
                        <h2 class="font-weight-bold h4">1. Contiene una selección única de los arábicas mejor clasificados</h2>
                        ...
                        <p>
                        <h2 class="font-weight-bold h4">2. Utiliza siempre la misma fórmula de café</h2>
                        ...
                        <p>
                        <h2 class="font-weight-bold h4">3. Meticuloso proceso de limpieza de los granos de café</h2>
                        ...
                        <p>
                        <h2 class="font-weight-bold h4"> 4. Tueste lento de 17/19 minutos</h2>
El tostado lento, sin prisas, durante mas de 17 minutos a 225º es otra de las principales características del café Premium JOJULO. Esta lentitud permite el tostado de forma homogénea y uniforme de cada grano de café, ofreciendo un máximo espectro de aromas.</p>
                        <p>
                        <h2 class="font-weight-bold h4">5. Enfriado exclusivo por aire sin adulterar con agua </h2>
El posterior proceso exclusivo de enfriado por aire permite mantener el grado óptimo de humedad del café y conservar todos su aromas varietales sin añadir agua al café.
                        ...
                        <p>
                        <h2 class="font-weight-bold h4">6.Crianza de tres  semanas dentro del envase</h2>
Después del tueste, el café arábica Premium JOJULO es envasado en botes metálicos de 4 kilos y permanece en reposo a temperatura constante como mínimo durante tres semanas. Durante este tiempo, el café tostado terminará de afinar todos sus registros y matices organolépticos. Se trata de un exclusivo proceso de crianza después de la torrefacción.
                        ...
                        <p>
                        <h2 class="font-weight-bold h4">7. Probarlo una y otra vez</h2>
...
Probamos más de 1000 tazas de café al día para verificar el excelente sabor que todos (incluido tú) esperamos. Un lote de café se prueba al menos tres veces antes de’ ser aprobado, es decir, que cada sorbo de café Starbucks® que tomes ’ hará’ tus delicias.
                ...
                <aside class=" col-md-3">
                    <img class="img-fluid" src="img/arabica.robusta.jpg" alt="grano de cafe"> 
                    <img class="img-fluid mt-5 w-100" src="img/paqueteCafe.png" alt="paquete de cafe">
                    </img>
                </aside>
            </main>
        </div>
