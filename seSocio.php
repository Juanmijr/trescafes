            ...
            <div class="d-flex justify-content-center ">
                <div class="card1 ">
                    <div class="card-header">
                        <h1 class="h3 text-titleNuevo">Sé Socio</h1>
                    ...
                    <div class="card-body">
                        <form id="form1" method="POST" action="" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col">
                                    <label class="d-flex justify-content-left  text-footer-cuerpo" for="usuario">Usuario</label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input id="apellido1"  pattern='^[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+$' required="" type="text" name="apellido1" class="form-control" placeholder="apellido 1 *" value="<?php if (isset($_POST['apellido1Google'])){ echo "$_POST[apellido1Google]";}else{if (isset($_POST['enviar'])){ echo $_POST['apellido1']; }}  ?>">
                                        <div class="valid-feedback d-block">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input id="apellido2"  pattern='^[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+$' type="text" name="apellido2" class="form-control" placeholder="apellido 2"value="<?php if (isset($_POST['apellido2Google'])){ echo "$_POST[apellido2Google]";}else{if (isset($_POST['enviar'])){ echo $_POST['apellido2']; }}  ?>">
                                        <div class="valid-feedback d-block">
                                            Solo se admiten letras
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input id="nombre" type="text" name="nombre" required=""  pattern='^[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+(\s*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]*)*[a-zA-ZÀ-ÿ\u00f1\u00d1 ]+$' class="form-control" placeholder="nombre *" value="<?php if (isset($_POST['nombreGoogle'])){ echo "$_POST[nombreGoogle]";}else{if (isset($_POST['enviar'])){ echo $_POST['nombre']; }} ?>">
                                        <div class="valid-feedback d-block">
                                            Solo se admiten letras
                                        </div>
                                    </div>   
                                ...
                                <div class="col-sm-6">
                                    <label for="emailSeSocio" class="d-flex justify-content-left  text-footer-cuerpo">Email</label>
                                    <div class="input-group form-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-mail-bulk"></i></span>
                                        </div>
                                        <input id="emailSeSocio" type="email" name="email" required="" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" class="form-control" placeholder="email *" value="<?php  if (isset($_POST['emailGoogle'])){ echo "$_POST[emailGoogle]";}else{if (isset($_POST['enviar'])){ echo $_POST['email']; }} ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input type="text" id="fechaNac" onfocus="(this.type = 'date')" name="fechaNacimiento" required="" class="form-control" placeholder="fecha de nacimiento *" value="<?php if (isset($_POST['enviar'])){ echo $_POST['fechaNacimiento']; } ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
